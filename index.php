                    ...
                    if ($row > 0) {
                        ...
                        foreach ($row as $res) {
                            if ($menuCode != '') {
                                ...
                                echo "<td>" . $res['IDFacultades'] . "</td>";
                                echo "<td>";
                                echo '<a href="./view/menu/read.php?id=' . $res['Idprogramas'] . '" class="mr-3" title="View Record" data-toggle="tooltip"><span class="fa fa-eye"></span></a>';
                                echo '<a href="./view/menu/update.php?id=' . $res['Idprogramas'] . '" class="mr-3" title="Update Record" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>';
                                echo '<a href="./view/menu/delete.php?id=' . $res['Idprogramas'] . '" title="Delete Record" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
                                echo "</td>";
                                echo "</tr>";
                                $menuCode_error = false;
                            }
