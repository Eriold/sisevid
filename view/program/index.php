                        ...
                        foreach ($row as $res) {
                            if ($idProgramas != '') {
                                if ($idProgramas == $res['Idprogramas']) {
                                    ...
                                    echo "<td>";
                                    echo '<a href="read.php?id=' . $res['Idprogramas'] . '" class="mr-3" title="View Record" data-toggle="tooltip"><span class="fa fa-eye"></span></a>';
                                    echo '<a href="update.php?id=' . $res['Idprogramas'] . '" class="mr-3" title="Update Record" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>';
                                    echo '<a href="delete.php?id=' . $res['Idprogramas'] . '" title="Delete Record" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
                                    echo "</td>";
                                    echo "</tr>";
